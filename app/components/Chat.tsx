...
export default function Chat() {
    const { panelOpen, setPanelOpen, submitMessage, messages, error, handleInputChange, input, status, stop } = useContext(TodoContext);
    ...
    return (
        <div className={`flex flex-col items-center justify-center min-h-screen ${panelOpen ? 'w-1/2' : 'w-16'} h-full border-r transition-width duration-300 relative bg-gray-900`}>
